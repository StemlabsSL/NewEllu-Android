...
public final class FragmentMediaBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvMediaMain;

  private FragmentMediaBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvMediaMain) {
    this.rootView = rootView;
    this.rvMediaMain = rvMediaMain;
  }
  ...
  public static FragmentMediaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rvMediaMain;
      RecyclerView rvMediaMain = rootView.findViewById(id);
      if (rvMediaMain == null) {
        break missingId;
      }

      return new FragmentMediaBinding((LinearLayout) rootView, rvMediaMain);
    }
