...
public final class ItemLinkBinding implements ViewBinding {
  ...
  private ItemLinkBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivMedia,
      @NonNull LinearLayout llItemMain, @NonNull TextView tvDescription,
  ...
  public static ItemLinkBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_link, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemLinkBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLinkBinding((LinearLayout) rootView, ivMedia, llItemMain, tvDescription,
          tvtitle);
    }
