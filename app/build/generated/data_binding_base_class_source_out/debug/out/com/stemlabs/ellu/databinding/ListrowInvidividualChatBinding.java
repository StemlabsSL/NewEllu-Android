...
public final class ListrowInvidividualChatBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView tvProximityMessage;
  ...
  @NonNull
  public final TextView tvTimeReceiveAudio;
  ...
  private ListrowInvidividualChatBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView imgAwareMeetIcon, @NonNull RoundRectCornerImageView imgChatReceive,
      ...
      @NonNull LinearLayout llContact, @NonNull LinearLayout llProximityView,
      @NonNull FrameLayout rlReceiver, @NonNull FrameLayout rlSend,
      @NonNull AppCompatSeekBar seekbarAudioReceive, @NonNull AppCompatSeekBar seekbarAudioSend,
      @NonNull TextView tvAcceptProximity, @NonNull TextView tvAddContact,
      @NonNull TextView tvAwareMeetTitle, @NonNull TextView tvMessageReceive,
      @NonNull TextView tvMessageSend, @NonNull TextView tvProximityMessage,
      @NonNull TextView tvTimeAudioReceive, @NonNull TextView tvTimeAudioSend,
      @NonNull TextView tvTimeReceive, @NonNull TextView tvTimeReceiveAudio,
  ...
  @NonNull
  public static ListrowInvidividualChatBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListrowInvidividualChatBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.listrow_invidividual_chat, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListrowInvidividualChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvAddContact;
      TextView tvAddContact = rootView.findViewById(id);
      if (tvAddContact == null) {
        break missingId;
      }
      ...
      id = R.id.tvProximityMessage;
      TextView tvProximityMessage = rootView.findViewById(id);
      if (tvProximityMessage == null) {
        break missingId;
      }
      ...
      id = R.id.tvTimeReceiveAudio;
      TextView tvTimeReceiveAudio = rootView.findViewById(id);
      if (tvTimeReceiveAudio == null) {
        break missingId;
      }
      ...
      return new ListrowInvidividualChatBinding((RelativeLayout) rootView, imgAwareMeetIcon,
          imgChatReceive, imgChatSend, imgMap, imgPlayReceive, imgPlaySend, imgProfileReceive,
          imgReceiveArrow, imgSeenSend, llAudioReceive, llAudioSend, llAwareMeetView, llContact,
          llProximityView, rlReceiver, rlSend, seekbarAudioReceive, seekbarAudioSend,
          tvAcceptProximity, tvAddContact, tvAwareMeetTitle, tvMessageReceive, tvMessageSend,
          tvProximityMessage, tvTimeAudioReceive, tvTimeAudioSend, tvTimeReceive,
          tvTimeReceiveAudio, tvTimeSend, tvUserNameReceive, tvUserNameSend);
    }
