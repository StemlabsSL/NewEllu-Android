...
public final class ViewProgressDialogBinding implements ViewBinding {
  ...
  private ViewProgressDialogBinding(@NonNull RelativeLayout rootView,
      @NonNull ProgressBar progressBarPB, @NonNull TextView progressMessageTV) {
    this.rootView = rootView;
    this.progressBarPB = progressBarPB;
    this.progressMessageTV = progressMessageTV;
  }
  ...
  public static ViewProgressDialogBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.progressBarPB;
      ProgressBar progressBarPB = rootView.findViewById(id);
      if (progressBarPB == null) {
        break missingId;
      }

      id = R.id.progressMessageTV;
      TextView progressMessageTV = rootView.findViewById(id);
      if (progressMessageTV == null) {
        break missingId;
      }

      return new ViewProgressDialogBinding((RelativeLayout) rootView, progressBarPB,
          progressMessageTV);
    }
