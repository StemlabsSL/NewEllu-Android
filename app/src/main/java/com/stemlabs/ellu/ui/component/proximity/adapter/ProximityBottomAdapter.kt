...
import kotlinx.android.synthetic.main.item_proximity_bottom.view.*
import java.util.ArrayList

class ProximityBottomAdapter(var arrayList: MutableList<ChatActionModel>) : RecyclerView.Adapter<ProximityBottomAdapter.ChatItemActionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatItemActionViewHolder {
        ...
        return ChatItemActionViewHolder(LayoutInflater.from(context).inflate(R.layout.item_proximity_bottom, parent, false))
    }
    ...
    inner class ChatItemActionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var imageView = itemView.ivAction!!
