...
public class CustomOtpView extends LinearLayout {
    ...
    private EditText otpEdit1, otpEdit2, otpEdit3, otpEdit4, otpEdit5,
    ...
    private void init(AttributeSet attrs) {
        ...
        otpEdit5 = findViewById(R.id.otp_edit_5);
    ...
    private String makeOTP() {
        ...
        stringBuilder.append(otpEdit5.getText().toString());
    ...
    public void setOTP(String otp) {
        ...
        otpEdit5.setText(String.format("%s", otp.charAt(3)));
    }


    private void styleEditTexts(TypedArray styles) {
        int textColor = getResources().getColor(R.color.colorWhite);
        int textSize = (int) getResources().getDimension(R.dimen._14ssp);
        ...
        if (hint != null) {
            ...
            otpEdit5.setHint(hint);
        }

        otpEdit1.setTypeface(ResourcesCompat.getFont(getContext(),R.font.roboto_medium));
        otpEdit2.setTypeface(ResourcesCompat.getFont(getContext(),R.font.roboto_medium));
        otpEdit3.setTypeface(ResourcesCompat.getFont(getContext(),R.font.roboto_medium));
        otpEdit4.setTypeface(ResourcesCompat.getFont(getContext(),R.font.roboto_medium));
        otpEdit5.setTypeface(ResourcesCompat.getFont(getContext(),R.font.roboto_medium));
        drawable = getResources().getDrawable(R.drawable.underline_white);
        drawableSelected = getResources().getDrawable(R.drawable.underline_white);
        ...
        if (drawable != null) {
            ...
            otpEdit5.setBackground(drawable);
            ...
            otpEdit5.setBackgroundColor(bgColor);
            ...
            otpEdit5.getBackground().mutate().setColorFilter(textColor, PorterDuff.Mode.SRC_ATOP);
        }
        ...
        otpEdit5.setTextColor(textColor);
        ...
        otpEdit5.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    private void setEditTextInputStyle(TypedArray styles) {
        ...
        otpEdit5.setInputType(inputType);
        ...
        otpEdit5.setFilters(new InputFilter[]{new InputFilter.LengthFilter(maxLength)});
        ...
        if (!TextUtils.isEmpty(text) && text.length() == 4) {
            ...
            otpEdit5.setText(String.valueOf(text.charAt(3)));
        }
        setFocusListener();
    ...
    private void setFocusListener() {
        ...
        otpEdit5.setOnFocusChangeListener(onFocusChangeListener);
        ...
        otpEdit5.setOnKeyListener(new OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_DEL) {
                    otpEdit5.setText("");
    ...
    public void disableKeypad() {
        ...
        otpEdit5.setOnTouchListener(touchListener);
    }
    ...
    private void setOnTextChangeListener() {
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                } else if (otpEdit3.getText().toString().length() > 0) {
                    otpEdit4.requestFocus();
                } else if (otpEdit2.getText().toString().length() > 0) {
                    otpEdit3.requestFocus();
                } else if (otpEdit1.getText().toString().length() > 0) {
                    otpEdit2.requestFocus();
                } else if (otpEdit1.getText().toString().length() == 0) {
                    otpEdit1.requestFocus();
                }
                ...
                if (mCurrentlyFocusedEditText.getText().length() >= 1
                    ...
                    if (getContext().getResources().getConfiguration().getLayoutDirection() == LayoutDirection.LTR) {
        ...
        otpEdit5.addTextChangedListener(textWatcher);
    }
