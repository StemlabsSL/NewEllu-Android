...
*/
    ...
    /*public static void errorResponseMsg(Context context, String response, String okMsg) {

        try {
            Gson gson = new Gson();
            ErrorResponse loginError = gson.fromJson(response, ErrorResponse.class);
            GlobalMethods.Dialog(context, loginError.getError().getMessage(), okMsg);
