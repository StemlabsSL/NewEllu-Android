...
public class MonthGridAdapter extends BaseAdapter {
    ...
    class MyViewHolder {
        ...
        public MyViewHolder(View view, boolean isMonthView) {
            ...
            Typeface typeface = mContext.getResources().getFont(R.font.raleway_regular);
            tvCalendarWeekDayName.setTypeface(typeface);
            tvCalendarWeekDayName.setAllCaps(true);
            ...
            if (isMonthView) {
                ...
                tvCalendarMonthDay.setMinTextSize(20);
                tvCalendarWeekDayName.setMinTextSize(20);
            }
        }
    }
}
